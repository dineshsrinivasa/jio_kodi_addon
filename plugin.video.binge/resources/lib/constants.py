...
# Endpoints
OTP_RMN_URL         = API_KONG + "/rest-api/pub/api/v1/rmn/{rmn}/otp"
OTP_SID_URL         = API_KONG + "/rest-api/pub/api/v1/subscribers/{sid}/otp"
LOGIN_URL           = API_KONG + "/rest-api/pub/api/v2/login/ott"
SID_LOOKUP_URL      = API_KONG + "/rest-api/pub/api/v1/subscriberLookup?rmn={rmn}"
